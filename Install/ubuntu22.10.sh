...
#Repositories#
echo "#Ubuntu Kinetic Kudu
deb http://ports.ubuntu.com/ubuntu-ports kinetic main restricted universe multiverse
...
deb http://ports.ubuntu.com/ubuntu-ports kinetic-proposed main restricted universe multiverse
deb http://ports.ubuntu.com/ubuntu-ports kinetic-backports main restricted universe multiverse" > ~/"$folder"/etc/apt/sources.list
   clear
   echo " "
