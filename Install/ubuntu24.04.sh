...
#deb http://ports.ubuntu.com/ubuntu-ports noble-proposed main restricted universe multiverse
#deb http://ports.ubuntu.com/ubuntu-ports noble-backports main restricted universe multiverse" > ~/"$folder"/etc/apt/sources.list
